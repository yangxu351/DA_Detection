...
class real_nwpu(imdb):
    def __init__(self, image_set='real_nwpu_c1_test', devkit_path=None):
        ...
        self._classes = ('NWPU_C0',  # __background__ always index 0
    ...
    def selective_search_roidb(self):
        ...
        if int(self._year) == 2007 or 'test' not in self._image_set:
    ...
    def _get_voc_results_file_template(self):
        # VOCdevkit/results/<comp_id>_det_test_NWPU_C1.txt
...
if __name__ == '__main__':
    # d = real_nwpu('real_nwpu_c1_train')
    # d = real_nwpu('real_nwpu_c1_val')
    
    d = real_nwpu('real_nwpu_c1_test')
